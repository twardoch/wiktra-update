...
function senseid_wikidata_track(lang, id)
	if Wikidata_id(id) then
		...
		if Wikidata_entity_is_any_of(id, {"Q30014", "Q3504248", "Q17362350"}) then
			table.insert(tracking, "senseid/Wikidata/planet")
		end
		
		-- Q2199: dwarf planet
		if Wikidata_entity_is_any_of(id, {"Q2199"}) then
			table.insert(tracking, "senseid/Wikidata/dwarf planet")
		end
		...
		if Wikidata_entity_is_any_of(id, {"Q11688446"}) then
